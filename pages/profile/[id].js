...
// connecting wallet 
 ...
 // follow user 
  async function followUser() {
    // creating a provider that allows to connect to ETH network through user's wallet.
    const provider = new ethers.providers.Web3Provider(window.ethereum);
    // grabbing the signer from the provider to sign and send transactions
    const signer = provider.getSigner();
    // interact with LensHub smart contract
